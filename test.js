...
var fsAccess = require('./');
fs.access = fsAccess;
fs.accessSync = fsAccess.sync;
fs.F_OK = fs.access.F_OK;
fs.R_OK = fs.access.R_OK;
fs.W_OK = fs.access.W_OK;
fs.X_OK = fs.access.X_OK;


// https://github.com/iojs/io.js/blob/18d457bd3408557a48b453f13b2b99e1ab5e7159/test/parallel/test-fs-access.js
var doesNotExist = __filename + '__this_should_not_exist';
var readOnlyFile = path.join(osTmpdir(), 'read_only_file');
var readWriteFile = path.join(osTmpdir(), 'read_write_file');
